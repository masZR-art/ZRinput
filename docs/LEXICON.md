...
| Cold load plus five CLI queries | 658 ms |
| Peak CLI working set (100 prefix queries) | 93.11 MiB |

The measurements were taken on the development Windows 11 x64 machine on
2026-08-07. A second clean generation produced byte-identical TSV, syllable,
and ZRDICT outputs.
